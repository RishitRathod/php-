...
if(isset($_POST['Save'])){
    ...
    $sql = "INSERT INTO student.student_data (name, sem, email, cgpa, department, dob)
...
<body>
    <form id="student-form"action="student_edit1.php" method="post">
        <h1>Student Form</h1>
        <label for="name">Enter name:</label>
        <input type="text" name="name" value=<?php echo $name; ?>  id="name" required>
    
        <label for="sem">Enter sem:</label>
        <input type="number" name="sem" id="sem" value=<?php echo $sem; ?> >
    
        <label for="email">Enter email:</label>
        <input type="email" name="email" id="email" value=<?php echo $email; ?> >

        <label for="cgpa">Enter cgpa:</label>
        <input type="text" name="cgpa" id="cgpa" value=<?php echo $cgpa; ?> >

        <input type="hidden" name="ide" id="ide" value=<?php $v; echo $v;?> >
        <label for="date">select dob:</label>
